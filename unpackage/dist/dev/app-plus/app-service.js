...
`, "color: #ffffff; background: #3c9cff; padding:5px 0;", "color: #3c9cff;background: #ffffff; padding:5px 0;");
  ...
  const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$g], ["__scopeId", "data-v-1c933a9a"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-icon/u-icon.vue"]]);
  const props$e = {
    props: {
      // 显示的内容，字符串
      text: {
        type: [Array],
        default: props$g.columnNotice.text
      },
      // 是否显示左侧的音量图标
      icon: {
        type: String,
        default: props$g.columnNotice.icon
      },
      // 通告模式，link-显示右箭头，closable-显示右侧关闭图标
      mode: {
        type: String,
        default: props$g.columnNotice.mode
      },
      // 文字颜色，各图标也会使用文字颜色
      color: {
        type: String,
        default: props$g.columnNotice.color
      },
      // 背景颜色
      bgColor: {
        type: String,
        default: props$g.columnNotice.bgColor
      },
      // 字体大小，单位px
      fontSize: {
        type: [String, Number],
        default: props$g.columnNotice.fontSize
      },
      // 水平滚动时的滚动速度，即每秒滚动多少px(px)，这有利于控制文字无论多少时，都能有一个恒定的速度
      speed: {
        type: [String, Number],
        default: props$g.columnNotice.speed
      },
      // direction = row时，是否使用步进形式滚动
      step: {
        type: Boolean,
        default: props$g.columnNotice.step
      },
      // 滚动一个周期的时间长，单位ms
      duration: {
        type: [String, Number],
        default: props$g.columnNotice.duration
      },
      // 是否禁止用手滑动切换
      // 目前HX2.6.11，只支持App 2.5.5+、H5 2.5.5+、支付宝小程序、字节跳动小程序
      disableTouch: {
        type: Boolean,
        default: props$g.columnNotice.disableTouch
      }
    }
  };
  const _sfc_main$i = {
  ...
  const __easycom_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$f], ["__scopeId", "data-v-6c9dce4e"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-column-notice/u-column-notice.vue"]]);
  const props$d = {
    props: {
      // 显示的内容，字符串
      text: {
        type: String,
        default: props$g.rowNotice.text
      },
      // 是否显示左侧的音量图标
      icon: {
        type: String,
        default: props$g.rowNotice.icon
      },
      // 通告模式，link-显示右箭头，closable-显示右侧关闭图标
      mode: {
        type: String,
        default: props$g.rowNotice.mode
      },
      // 文字颜色，各图标也会使用文字颜色
      color: {
        type: String,
        default: props$g.rowNotice.color
      },
      // 背景颜色
      bgColor: {
        type: String,
        default: props$g.rowNotice.bgColor
      },
      // 字体大小，单位px
      fontSize: {
        type: [String, Number],
        default: props$g.rowNotice.fontSize
      },
      // 水平滚动时的滚动速度，即每秒滚动多少px(rpx)，这有利于控制文字无论多少时，都能有一个恒定的速度
      speed: {
        type: [String, Number],
        default: props$g.rowNotice.speed
      }
    }
  };
  const _sfc_main$h = {
  ...
  const __easycom_1$5 = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$e], ["__scopeId", "data-v-462e724c"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-row-notice/u-row-notice.vue"]]);
  const props$c = {
    props: {
      // 显示的内容，数组
      text: {
        type: [Array, String],
        default: props$g.noticeBar.text
      },
      // 通告滚动模式，row-横向滚动，column-竖向滚动
      direction: {
        type: String,
        default: props$g.noticeBar.direction
      },
      // direction = row时，是否使用步进形式滚动
      step: {
        type: Boolean,
        default: props$g.noticeBar.step
      },
      // 是否显示左侧的音量图标
      icon: {
        type: String,
        default: props$g.noticeBar.icon
      },
      // 通告模式，link-显示右箭头，closable-显示右侧关闭图标
      mode: {
        type: String,
        default: props$g.noticeBar.mode
      },
      // 文字颜色，各图标也会使用文字颜色
      color: {
        type: String,
        default: props$g.noticeBar.color
      },
      // 背景颜色
      bgColor: {
        type: String,
        default: props$g.noticeBar.bgColor
      },
      // 水平滚动时的滚动速度，即每秒滚动多少px(px)，这有利于控制文字无论多少时，都能有一个恒定的速度
      speed: {
        type: [String, Number],
        default: props$g.noticeBar.speed
      },
      // 字体大小
      fontSize: {
        type: [String, Number],
        default: props$g.noticeBar.fontSize
      },
      // 滚动一个周期的时间长，单位ms
      duration: {
        type: [String, Number],
        default: props$g.noticeBar.duration
      },
      // 是否禁止用手滑动切换
      // 目前HX2.6.11，只支持App 2.5.5+、H5 2.5.5+、支付宝小程序、字节跳动小程序
      disableTouch: {
        type: Boolean,
        default: props$g.noticeBar.disableTouch
      },
      // 跳转的页面路径
      url: {
        type: String,
        default: props$g.noticeBar.url
      },
      // 页面跳转的类型
      linkType: {
        type: String,
        default: props$g.noticeBar.linkType
      }
    }
  };
  const _sfc_main$g = {
  ...
  function _sfc_render$d(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_u_row_notice = resolveEasycom(vue.resolveDynamicComponent("u-row-notice"), __easycom_1$5);
  ...
  const __easycom_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$d], ["__scopeId", "data-v-63dbbc8e"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-notice-bar/u-notice-bar.vue"]]);
  const props$b = {
    props: {
      // 是否显示组件
      show: {
  ...
  const __easycom_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$c], ["__scopeId", "data-v-00752c6d"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-loading-icon/u-loading-icon.vue"]]);
  const props$a = {
    props: {
      // 轮播的长度
      length: {
  ...
  const __easycom_1$4 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$b], ["__scopeId", "data-v-23112adb"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-swiper-indicator/u-swiper-indicator.vue"]]);
  const props$9 = {
    props: {
  ...
  const __easycom_1$3 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$a], ["__scopeId", "data-v-eda42115"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-swiper/u-swiper.vue"]]);
  const props$8 = {
    props: {
      // 宫格的name
      name: {
        type: [String, Number, null],
        default: props$g.gridItem.name
      },
      // 背景颜色
      bgColor: {
        type: String,
        default: props$g.gridItem.bgColor
      }
    }
  };
  const _sfc_main$c = {
  ...
  const __easycom_3 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$9], ["__scopeId", "data-v-d5274fb5"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-grid-item/u-grid-item.vue"]]);
  const props$7 = {
    props: {
      // 分成几列
      col: {
        type: [String, Number],
        default: props$g.grid.col
      },
      // 是否显示边框
      border: {
        type: Boolean,
        default: props$g.grid.border
      },
      // 宫格对齐方式，表现为数量少的时候，靠左，居中，还是靠右
      align: {
        type: String,
        default: props$g.grid.align
      }
    }
  };
  const _sfc_main$b = {
  ...
  const __easycom_4 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$8], ["__scopeId", "data-v-85602471"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-grid/u-grid.vue"]]);
  const props$6 = {
    props: {
      // 是否细边框
      hairline: {
  ...
  const __easycom_5 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$7], ["__scopeId", "data-v-461e713c"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-button/u-button.vue"]]);
  const props$5 = {
    props: {
      color: {
        type: String,
  ...
  const __easycom_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$6], ["__scopeId", "data-v-bbd9963c"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-line/u-line.vue"]]);
  const props$4 = {
    props: {
      // 标题
      title: {
        type: [String, Number],
        default: props$g.cell.title
      },
      // 标题下方的描述信息
      label: {
        type: [String, Number],
        default: props$g.cell.label
      },
      // 右侧的内容
      value: {
        type: [String, Number],
        default: props$g.cell.value
      },
      // 左侧图标名称，或者图片链接(本地文件建议使用绝对地址)
      icon: {
        type: String,
        default: props$g.cell.icon
      },
      // 是否禁用cell
      disabled: {
        type: Boolean,
        default: props$g.cell.disabled
      },
      // 是否显示下边框
      border: {
        type: Boolean,
        default: props$g.cell.border
      },
      // 内容是否垂直居中(主要是针对右侧的value部分)
      center: {
        type: Boolean,
        default: props$g.cell.center
      },
      // 点击后跳转的URL地址
      url: {
        type: String,
        default: props$g.cell.url
      },
      // 链接跳转的方式，内部使用的是uView封装的route方法，可能会进行拦截操作
      linkType: {
        type: String,
        default: props$g.cell.linkType
      },
      // 是否开启点击反馈(表现为点击时加上灰色背景)
      clickable: {
        type: Boolean,
        default: props$g.cell.clickable
      },
      // 是否展示右侧箭头并开启点击反馈
      isLink: {
        type: Boolean,
        default: props$g.cell.isLink
      },
      // 是否显示表单状态下的必填星号(此组件可能会内嵌入input组件)
      required: {
        type: Boolean,
        default: props$g.cell.required
      },
      // 右侧的图标箭头
      rightIcon: {
        type: String,
        default: props$g.cell.rightIcon
      },
      // 右侧箭头的方向，可选值为：left，up，down
      arrowDirection: {
        type: String,
        default: props$g.cell.arrowDirection
      },
      // 左侧图标样式
      iconStyle: {
        type: [Object, String],
      ...
      size: {
        type: String,
        default: props$g.cell.size
      },
      // 点击cell是否阻止事件传播
      stop: {
        type: Boolean,
        default: props$g.cell.stop
      },
      // 标识符，cell被点击时返回
      name: {
        type: [Number, String],
        default: props$g.cell.name
      }
    }
  };
  const _sfc_main$8 = {
      ...
      vue.createElementVNode(
        ...
        [
          ...
          _ctx.$slots["right-icon"] || _ctx.isLink ? (vue.openBlock(), vue.createElementBlock(
            ...
            [
              _ctx.$slots["right-icon"] ? vue.renderSlot(_ctx.$slots, "right-icon", { key: 0 }, void 0, true) : (vue.openBlock(), vue.createBlock(_component_u_icon, {
                key: 1,
                name: _ctx.rightIcon,
  ...
  const __easycom_6 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$5], ["__scopeId", "data-v-b4243719"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-cell/u-cell.vue"]]);
  const props$3 = {
    props: {
      // 是否显示圆点
      isDot: {
  ...
  const __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$4], ["__scopeId", "data-v-aa9883b1"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-badge/u-badge.vue"]]);
  const props$2 = {
    props: {
      // item标签的名称，作为与u-tabbar的value参数匹配的标识符
      name: {
        type: [String, Number, null],
        default: props$g.tabbarItem.name
      },
      // uView内置图标或者绝对路径的图片
      icon: {
        icon: String,
        default: props$g.tabbarItem.icon
      },
      // 右上角的角标提示信息
      badge: {
        type: [String, Number, null],
        default: props$g.tabbarItem.badge
      },
      // 是否显示圆点，将会覆盖badge参数
      dot: {
        type: Boolean,
        default: props$g.tabbarItem.dot
      },
      // 描述文本
      text: {
        type: String,
        default: props$g.tabbarItem.text
      },
      // 控制徽标的位置，对象或者字符串形式，可以设置top和right属性
      badgeStyle: {
        type: [Object, String],
        default: props$g.tabbarItem.badgeStyle
      }
    }
  };
  const _sfc_main$6 = {
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_u_icon = resolveEasycom(vue.resolveDynamicComponent("u-icon"), __easycom_2);
    const _component_u_badge = resolveEasycom(vue.resolveDynamicComponent("u-badge"), __easycom_1$1);
    return vue.openBlock(), vue.createElementBlock(
      "view",
      {
        class: "u-tabbar-item",
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$3], ["__scopeId", "data-v-a54be951"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-tabbar-item/u-tabbar-item.vue"]]);
  const props$1 = {
    props: {}
  };
  const _sfc_main$5 = {
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$2], ["__scopeId", "data-v-3ec581de"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-safe-bottom/u-safe-bottom.vue"]]);
  const props = {
    props: {
      // 当前匹配项的name
      value: {
        type: [String, Number, null],
        default: props$g.tabbar.value
      },
      // 是否为iPhoneX留出底部安全距离
      safeAreaInsetBottom: {
        type: Boolean,
        default: props$g.tabbar.safeAreaInsetBottom
      },
      // 是否显示上方边框
      border: {
        type: Boolean,
        default: props$g.tabbar.border
      },
      // 元素层级z-index
      zIndex: {
        type: [String, Number],
        default: props$g.tabbar.zIndex
      },
      // 选中标签的颜色
      activeColor: {
        type: String,
        default: props$g.tabbar.activeColor
      },
      // 未选中标签的颜色
      inactiveColor: {
        type: String,
        default: props$g.tabbar.inactiveColor
      },
      // 是否固定在底部
      fixed: {
        type: Boolean,
        default: props$g.tabbar.fixed
      },
      // fixed定位固定在底部时，是否生成一个等高元素防止塌陷
      placeholder: {
        type: Boolean,
        default: props$g.tabbar.placeholder
      }
    }
  };
  const _sfc_main$4 = {
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_u_safe_bottom = resolveEasycom(vue.resolveDynamicComponent("u-safe-bottom"), __easycom_0);
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$1], ["__scopeId", "data-v-d5be2d5d"], ["__file", "D:/parking-client/node_modules/uview-plus/components/u-tabbar/u-tabbar.vue"]]);
  const _sfc_main$3 = {
    __name: "index",
    setup(__props) {
      ...
      const click1 = (index2) => {
        let url2 = "";
        if (index2 === 0) {
          url2 = "/pages/index/index";
        } else if (index2 === 1) {
          url2 = "/pages/orders/orders";
        } else {
          url2 = "/pages/account/account";
        }
        uni.switchTab({
          url: url2
        });
      ...
      return (_ctx, _cache) => {
        const _component_u_notice_bar = resolveEasycom(vue.resolveDynamicComponent("u-notice-bar"), __easycom_0$3);
        const _component_u_swiper = resolveEasycom(vue.resolveDynamicComponent("u-swiper"), __easycom_1$3);
        const _component_u_icon = resolveEasycom(vue.resolveDynamicComponent("u-icon"), __easycom_2);
        const _component_u_grid_item = resolveEasycom(vue.resolveDynamicComponent("u-grid-item"), __easycom_3);
        const _component_u_grid = resolveEasycom(vue.resolveDynamicComponent("u-grid"), __easycom_4);
        const _component_u_button = resolveEasycom(vue.resolveDynamicComponent("u-button"), __easycom_5);
        const _component_u_cell = resolveEasycom(vue.resolveDynamicComponent("u-cell"), __easycom_6);
        const _component_u_tabbar_item = resolveEasycom(vue.resolveDynamicComponent("u-tabbar-item"), __easycom_0$1);
        const _component_u_tabbar = resolveEasycom(vue.resolveDynamicComponent("u-tabbar"), __easycom_1);
        return vue.openBlock(), vue.createElementBlock("view", null, [
          vue.createCommentVNode(" 顶部导航 "),
          vue.createElementVNode("view", { class: "nav" }, [
            vue.createElementVNode("text", { class: "nav-title" }, "城市服务代客泊车小程序")
          ]),
          vue.createElementVNode("view", { class: "main" }, [
              ...
              vue.createVNode(_component_u_grid, {
                ...
                default: vue.withCtx(() => [
                  (vue.openBlock(true), vue.createElementBlock(
                    vue.Fragment,
                    null,
                    vue.renderList(list.value, (listItem, listIndex) => {
                        ...
                        { key: listIndex },
                        {
                          default: vue.withCtx(() => [
                            ...
                            vue.createElementVNode(
                              "text",
                              { class: "grid-text" },
                              vue.toDisplayString(listItem.title),
                              1
                              /* TEXT */
                            ),
                            vue.createElementVNode(
                              "text",
                              {
                                ...
                                style: vue.normalizeStyle({ opacity: listItem.small != "洗车服务" ? 1 : 0 })
                              },
                              vue.toDisplayString(listItem.small),
                              5
                              /* TEXT, STYLE */
                            )
                          ]),
            ...
            vue.createElementVNode("view", { class: "subscribe" }, [
              vue.createElementVNode("view", { class: "sub-le" }, [
                vue.createElementVNode("text", { class: "sub-le-title" }, "预约车辆：粤 AA63221"),
                vue.createElementVNode("text", { class: "sub-le-small" }, "预约泊车时间：2023 年 11 月 22 日 00:00")
              ]),
              vue.createElementVNode("text", { class: "sub-detail" }, "查看详情")
            ]),
            vue.createElementVNode("view", { class: "supermarket" }, [
              vue.createElementVNode("view", { class: "super-title" }, "线上生活超市"),
              vue.createElementVNode("view", { class: "super-content" }, [
                vue.createElementVNode("view", { class: "super-content-le" }, [
                  vue.createElementVNode("image", {
                    src: "/static/images/index/supermarket.png",
                    mode: ""
                  })
                ]),
                vue.createElementVNode("view", { class: "super-content-ri" }, [
                  vue.createElementVNode("view", { class: "super-cotent-title" }, "司美全网最低价"),
                  vue.createElementVNode("view", { class: "super-cotent-small" }, "夏天来了，肉肉藏不住"),
            ...
            vue.createElementVNode("view", { class: "driver" }, [
              vue.createElementVNode("view", { class: "driver-title" }, [
            ...
            default: vue.withCtx(() => [
              vue.createVNode(_component_u_tabbar_item, {
                ...
                "active-icon": vue.withCtx(() => [
                  vue.createElementVNode("image", {
                    style: { "width": "44rpx", "height": "40rpx", "margin": "0 0 6rpx" },
                    src: "/static/images/tabbar/index-active.png"
                  })
                ]),
              ...
              vue.createVNode(_component_u_tabbar_item, {
                ...
                "active-icon": vue.withCtx(() => [
                  vue.createElementVNode("image", {
                    style: { "width": "36rpx", "height": "40rpx", "margin": "0 0 6rpx" },
                    src: "/static/images/tabbar/orders-active.png"
                  })
                ]),
                "inactive-icon": vue.withCtx(() => [
                  vue.createElementVNode("image", {
                    style: { "width": "36rpx", "height": "40rpx", "margin": "0 0 6rpx" },
                    src: "/static/images/tabbar/orders.png"
                  })
                ]),
                _: 1
                /* STABLE */
              ...
              vue.createVNode(_component_u_tabbar_item, {
                ...
                "active-icon": vue.withCtx(() => [
                  vue.createElementVNode("image", {
                    style: { "width": "32rpx", "height": "42rpx", "margin": "0 0 6rpx" },
                    src: "/static/images/tabbar/account-active.png"
                  })
                ]),
                "inactive-icon": vue.withCtx(() => [
                  vue.createElementVNode("image", {
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-1cf27b2a"], ["__file", "D:/parking-client/pages/index/index.vue"]]);
  const _sfc_main$2 = {
    __name: "orders",
    setup(__props) {
  ...
  const PagesOrdersOrders = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-1acc51a1"], ["__file", "D:/parking-client/pages/orders/orders.vue"]]);
  const _sfc_main$1 = {
    __name: "account",
    setup(__props) {
      const value1 = vue.ref(2);
      const click1 = (index2) => {
        let url2 = "";
        if (index2 === 0) {
          url2 = "/pages/index/index";
  ...
  const PagesAccountAccount = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-8cce343a"], ["__file", "D:/parking-client/pages/account/account.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/parking-client/App.vue"]]);
