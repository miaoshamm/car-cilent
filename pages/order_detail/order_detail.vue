<template>
	<view v-if='isInvoice' style="min-height: 100vh; background: #F6F7F8;padding:32rpx 16rpx; ">
		<text style="color: #81335E; font-size: 36rpx;font-weight: bold;">申请开票</text>
		<up--form :ref='formRef'>
			...
			<button style="background-color: #DFA0B1;height: 88rpx;line-height: 88rpx;color: white;font-size: 32rpx;" @click="handleInvoice">开票</button>
		</up--form>
	</view>
	<view v-else style="min-height: 100vh; background: #F6F7F8;padding:32rpx 16rpx; ">
		<text style="color: #81335E; font-size: 36rpx;font-weight: bold;">泊车服务已结束</text>
