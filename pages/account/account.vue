<template>
	...
	<u-modal :show="isShowNickNameModal" title="修改昵称" showCancelButton @confirm="onChangeNickName"
		@cancel="isShowNickNameModal = false">
		<template #default>
			<input type="nickname" v-model="nickName" style="width: 100%" placeholder="请输入昵称" />
		</template>
	</u-modal>
	<u-modal :show="isShowSwitchUserModal" title="是否切换成用户" showCancelButton @confirm="switchUser"
		@cancel="isShowSwitchUserModal = false"></u-modal>
	<u-modal :show="isShowSwitchServiceModal" title="是否切换成服务人员" showCancelButton @confirm="roleModalConfirm"
		@cancel="isShowSwitchServiceModal = false"></u-modal>
</template>
