<template>
  ...
  <u-modal
    :show="isShowSwitchServiceModal"
    title="是否切换成服务人员"
    showCancelButton
    @confirm="roleModalConfirm"
    @cancel="isShowSwitchServiceModal = false"
  ></u-modal>
</template>

<script setup>
import { ref, computed } from "vue";
import { getPhone, putUserInfo, validateRole, getUserInfo } from "@/api";
