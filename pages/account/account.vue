<template>
	...
	<u-modal :show="isShowSwitchUserModal" title="确定切换为用户吗？" showCancelButton @confirm="switchUser" @cancel="isShowSwitchUserModal = false" confirmColor="#449656" />
	<u-modal :show="isShowSwitchServiceModal" title="确定切换为员工吗？" showCancelButton @confirm="roleModalConfirm" @cancel="roleModalColse = false" confirmColor="#449656" />
</template>
