	...
	<view style="min-height: 100vh; background: #f6f7f8">
		...
		<view class="main">
			...
			<view class="driver">
				...
				<swiper v-show="evaluate.length !== 0">
...
import { getBanner, getNotice, getServicerByType, getUserEvaluate, getCarServices, login, getUserAgreement, getUserInfo, getPhone, putUserInfo, getReservationOrder } from '@/api';
let banner = ref([]);
let notice = ref([]);
let driver = ref([]);
let evaluate = ref([]);
