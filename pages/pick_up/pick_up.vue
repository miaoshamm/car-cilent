      ...
      <view style="padding: 32rpx">
        <view class="card" style="background: linear-gradient(180deg, #ecfbec 0%, #ffffff 26%, #ffffff 100%)">
          <view class="card_line" style="min-height: 96rpx">
            ...
            <view style="display: flex; align-items: center; min-height: 96rpx; flex: 1; justify-content: flex-end; overflow: hidden" @click="openMap">
        ...
        <view style="background-color: white; padding: 0 32rpx; border-radius: 16rpx">
          <ChooseEmploy
            :isShow="isShowServiceList"
            :open="openServiceList"
            :close="serviceListClose"
            servicerType="TRANSFER"
...
<script setup>
import { reservationTravelOrder } from "../../api/index.js";
